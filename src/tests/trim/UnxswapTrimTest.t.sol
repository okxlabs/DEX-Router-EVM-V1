...
contract UnxswapTrimTest is TrimTestBase {
    ...
    function test_trim_unxswapTo_WETH2USDT_1trim_noCommission() tokenLogAndCheck(WETH, USDT, oneEther, true, false, false, false, false) public {
        bytes memory swapData = _generateWETH2USDTUnxswapData();
    ...
    function test_trim_unxswapTo_WETH2USDT_1trim_1toCommission() tokenLogAndCheck(WETH, USDT, oneEther, true, false, false, true, false) public {
        bytes memory swapData = _generateWETH2USDTUnxswapData();
        bytes memory trimData = _generate1TrimData();
    ...
    function test_trim_unxswapTo_WETH2USDT_1trim_2toCommission() tokenLogAndCheck(WETH, USDT, oneEther, true, false, false, true, true) public {
        bytes memory swapData = _generateWETH2USDTUnxswapData();
        bytes memory trimData = _generate1TrimData();
    ...
    function test_trim_unxswapTo_ETH2USDT_1trim_noCommission() tokenLogAndCheck(ETH, USDT, oneEther, true, false, false, false, false) public {
        bytes memory swapData = _generateETH2USDTUnxswapData();
        bytes memory trimData = _generate1TrimData();
        bytes memory data = bytes.concat(swapData, trimData);
    ...
    function test_trim_unxswapTo_ETH2USDT_1trim_1toCommission() tokenLogAndCheck(ETH, USDT, oneEther, true, false, false, true, false) public {
        bytes memory swapData = _generateETH2USDTUnxswapData();
        bytes memory trimData = _generate1TrimData();
        bytes memory commissionData = _generate1CommissionData(false, USDT);
        bytes memory data = bytes.concat(swapData, trimData, commissionData);
    ...
    function test_trim_unxswapTo_ETH2USDT_1trim_2toCommission() tokenLogAndCheck(ETH, USDT, oneEther, true, false, false, true, true) public {
        bytes memory swapData = _generateETH2USDTUnxswapData();
        bytes memory trimData = _generate1TrimData();
        bytes memory commissionData = _generate2CommissionData(false, USDT);
        bytes memory data = bytes.concat(swapData, trimData, commissionData);
    ...
    function test_trim_unxswapTo_USDT2ETH_1trim_noCommission() tokenLogAndCheck(USDT, ETH, 1000 * 10 ** 6, true, false, false, false, false) public {
        bytes memory swapData = _generateUSDT2ETHUnxswapData();
        bytes memory trimData = _generate1TrimData();
        bytes memory data = bytes.concat(swapData, trimData);
        (bool success, ) = address(dexRouter).call(data);
    ...
    function test_trim_unxswapTo_USDT2ETH_1trim_1toCommission() tokenLogAndCheck(USDT, ETH, 1000 * 10 ** 6, true, false, false, true, false) public {
        bytes memory swapData = _generateUSDT2ETHUnxswapData();
        bytes memory trimData = _generate1TrimData();
    ...
    function test_trim_unxswapTo_USDT2ETH_1trim_2toCommission() tokenLogAndCheck(USDT, ETH, 1000 * 10 ** 6, true, false, false, true, true) public {
        bytes memory swapData = _generateUSDT2ETHUnxswapData();
        bytes memory trimData = _generate1TrimData();
