...
async function main() {
  ...
  // }
   ...
   // Add limitOrder priorityAddresses
  // let isPriority = await dexRouter.priorityAddresses(limitOrder);
  // if(!isPriority){
  ...
  // Add commisson priorityAddresses
  let isPriority = await dexRouter.priorityAddresses(commisson);
  if(!isPriority){
  ...
  // Remove commisson priorityAddresses
  // let isPriority = await dexRouter.priorityAddresses(commisson);
  // if(isPriority){
  //   let result = await dexRouter.setPriorityAddress(commisson, false);
  //   console.log(`## Remove commisson:[%s] priority txHash:[%s]`, commisson, result.hash);
  // }else{
  //   console.log(`## Skip remove commisson:[%s] priority`, commisson);
  // }
}
