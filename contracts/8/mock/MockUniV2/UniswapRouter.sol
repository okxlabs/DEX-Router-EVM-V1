...
import "../../../5/interfaces/IERC20.sol";
import "../../interfaces/IUniswapV2Factory.sol";
import "../../../5/interfaces/IWETH.sol";
import "../../interfaces/IUnswapRouter02.sol";
import "../../../5/libraries/SafeMath.sol";
import "../../libraries/SafeToken.sol";
import "./UniswapV2Library.sol";

contract UniswapRouter is IUnswapRouter02 {
  ...
  function swapExactTokensForTokens(
    ...
    SafeToken.safeTransferFrom(path[0], msg.sender, UniswapV2Library.pairFor(factory, path[0], path[1]), amounts[0]);
  ...
  function swapExactTokensForTokensSupportingFeeOnTransferTokens(
    ...
    SafeToken.safeTransferFrom(path[0], msg.sender, UniswapV2Library.pairFor(factory, path[0], path[1]), amountIn);
