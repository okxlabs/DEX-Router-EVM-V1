...
contract EchodexAdapter is IAdapter {
    ...
    // May calculate slightly more fees, but within acceptable range. Hard to calculate accurately

    function _handlePreTax(
        address to,
        address pool,
        address fromToken,
        address toToken,
        ...
        uint256 fee = IEchodexFactory(factory).calcFeeOrReward(
            toToken,
            amountOut,
            10
        );
