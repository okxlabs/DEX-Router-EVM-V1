...
import "../interfaces/IZebraV3SwapCallback.sol";
...
contract ZebraV3Adapter is IAdapter, IZebraV3SwapCallback {
    ...
    function sellBase(
        ...
        _zebraV3Swap(to, pool, sqrtX96, data);
    }
