...
import "../interfaces/IFireflyV3SwapCallback.sol";
...
contract FireFlyV3Adapter is IAdapter, IFireflyV3SwapCallback {
    ...
    function sellBase(
        ...
        _fireflyV3Swap(to, pool, sqrtX96, data);
    }
