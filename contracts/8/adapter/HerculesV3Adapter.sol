...
import "../interfaces/IHerculesV3Pool.sol";
import "../interfaces/IERC20.sol";
import "../interfaces/IWETH.sol";
import "../libraries/SafeERC20.sol";
import "../libraries/TickMath.sol";

contract HerculesV3Adapter is IAdapter, IAlgebraSwapCallback {
    address constant ETH_ADDRESS = 0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE;

    address public immutable WETH;

    // weth in metis: 0x420000000000000000000000000000000000000A
    constructor(address payable weth) {
        WETH = weth;
    }

    function _herculesV3Swap(
        address to,
        address pool,
    ...
    function sellBase(
       ...
       (uint160 limitSqrtPrice, bytes memory data) = abi.decode(
        ...
        _herculesV3Swap(to, pool, limitSqrtPrice, data);
    }
